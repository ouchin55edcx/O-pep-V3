                        ...
                        <div class="-my-2 overflow-x-auto">
                            <div class="py-2 align-middle inline-block min-w-full">
                                ...
                                <div class="flex w-[100%] ">
                                    ...
                                    <div class="px-6 py-3 w-[50%] bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                        <div class="flex cursor-pointer">

                                            </p>
                                        </div>
                                    </div>
                                    <div class="px-6 w-[50%]  py-3 bg-gray-50 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
